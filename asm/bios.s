...
sub_1708: @ 0x00001708
	...
	UNALIGNED_THUMB_FUNC_START sub_170A
sub_170A: @ 0x0000170A
	push {r4, r7, lr}
...
sub_23B0: @ 0x000023B0
	...
	UNALIGNED_THUMB_FUNC_START sub_23C6
sub_23C6: @ 0x000023C6
	ldr r3, [r0, #0x2c]
	cmp r3, #0
	beq _23E4
...
_23E4:
	...
	UNALIGNED_THUMB_FUNC_START sub_23E6
sub_23E6: @ 0x000023E6
	push {r4, r5, r6, lr}
	adds r5, r1, #0
	ldrb r1, [r5]
...
sub_26C6: @ 0x000026C6
	...
	UNALIGNED_THUMB_FUNC_START sub_26CE
sub_26CE:
	push {lr}
_26D0:
	ldr r2, [r1, #0x40]
	...
	UNALIGNED_THUMB_FUNC_START sub_26EE
sub_26EE: @ 0x000026EE
	ldrb r2, [r1, #2]
	cmp r2, #3
	bhs _2706
...
_273E:
	...
	UNALIGNED_THUMB_FUNC_START sub_274A
sub_274A: @ 0x0000274A
	mov r12, lr
	bl sub_26C4
	strb r3, [r1, #0x1d]
...
sub_2768: @ 0x00002768
	...
	UNALIGNED_THUMB_FUNC_START sub_277A
sub_277A: @ 0x0000277A
	mov r12, lr
	ldr r2, [r1, #0x40]
	ldrb r3, [r2]
...
sub_27A8: @ 0x000027A8
	...
	UNALIGNED_THUMB_FUNC_START sub_27BA
sub_27BA: @ 0x000027BA
	mov r12, lr
	bl sub_26C4
	subs r3, #0x40
	...
	UNALIGNED_THUMB_FUNC_START sub_27CE
sub_27CE: @ 0x000027CE
	mov r12, lr
	bl sub_26C4
	subs r3, #0x40
	...
	UNALIGNED_THUMB_FUNC_START sub_27E2
sub_27E2: @ 0x000027E2
	mov r12, lr
	bl sub_26C4
	strb r3, [r1, #0xf]
...
sub_2804: @ 0x00002804
	...
	UNALIGNED_THUMB_FUNC_START sub_280E
sub_280E: @ 0x0000280E
	mov r12, lr
	bl sub_26C4
	strb r3, [r1, #0x17]
...
_281C:
	...
	UNALIGNED_THUMB_FUNC_START sub_281E
sub_281E: @ 0x0000281E
	mov r12, lr
	bl sub_26C4
	ldrb r0, [r1, #0x18]
...
_2834:
	...
	UNALIGNED_THUMB_FUNC_START sub_2836
sub_2836: @ 0x00002836
	mov r12, lr
	bl sub_26C4
	subs r3, #0x40
	...
	UNALIGNED_THUMB_FUNC_START sub_284A
sub_284A: @ 0x0000284A
	mov r12, lr
	ldr r2, [r1, #0x40]
	ldrb r3, [r2]
	...
	UNALIGNED_THUMB_FUNC_START sub_285E
sub_285E: @ 0x0000285E
	movs r0, r0
	.align 2, 0
...
_2CEE:
	...
	ldr r3, _2D38 @=0x6465646F
	cmp r6, #2
	bne _2D02
	ldr r0, _2D2C @=0x0000C37B
	ldr r3, _2D34 @=0x43202F2F
_2D02:
	ldr r1, _2D44 @=0x6F646573
	bl sub_287A
	cmp r2, r3
	bne _2D26
	ldr r2, [r7, #0x1c]
...
_2D26:
	...
	b _2D56
	.align 2, 0
_2D2C: .4byte 0x0000C37B
_2D30: .4byte 0x0000A517
_2D34: .4byte 0x43202F2F
_2D38: .4byte 0x6465646F
_2D3C: .4byte 0x20796220
_2D40: .4byte 0x6177614B
_2D44: .4byte 0x6F646573
_2D48: .4byte gUnknown_02000000
_2D4C: .4byte 0x60032003
_2D50:
	movs r0, #4
	strb r0, [r7, #0x11]
	strb r0, [r7, #0xf]
